!function(t, e) {
    ...
    function v(t, e) {
        for (var n, i, o = [], r = 0, s = t.length; r < s; r++)
            (i = t[r]).style && (n = i.style.display, e ? ("none" === n && (o[r] = Mt.get(i, "display") || null, o[r] || (i.style.display = "")), "" === i.style.display && Ht(i) && (o[r] = g(i))) : "none" !== n && (o[r] = "none", Mt.set(i, "display", n)));
        for (r = 0; r < s; r++)
    ...
    function x(t, e, n, i, o) {
        for (var r, s, a, l, c, u, d = e.createDocumentFragment(), h = [], p = 0, f = t.length; p < f; p++)
            if ((r = t[p]) || 0 === r)
                if ("object" === ft.type(r))
                    ft.merge(h, r.nodeType ? [r] : r);
                else if (Vt.test(r)) {
                    for (s = s || d.appendChild(e.createElement("div")), a = (Ut.exec(r) || ["", ""])[1].toLowerCase(), l = Qt[a] || Qt._default, s.innerHTML = l[1] + ft.htmlPrefilter(r) + l[2], u = l[0]; u--;)
                        s = s.lastChild;
                    ft.merge(h, s.childNodes), (s = d.firstChild).textContent = ""
                } else
                    h.push(e.createTextNode(r));
        for (d.textContent = "", p = 0; r = h[p++];)
            if (i && ft.inArray(r, i) > -1)
                o && o.push(r);
            else if (c = ft.contains(r.ownerDocument, r), s = y(d.appendChild(r), "script"), c && w(s), n)
                for (u = 0; r = s[u++];)
    ...
    function $(t, e) {
        var n,
            ...
            c;
        if (1 === e.nodeType) {
            if (Mt.hasData(t) && (r = Mt.access(t), s = Mt.set(e, r), c = r.events)) {
    ...
    function P(t, e, i, o) {
        ...
        var r,
            ...
            f = e[0],
            m = ft.isFunction(f);
        if (m || h > 1 && "string" == typeof f && !ht.checkClone && ee.test(f))
            return t.each(function(n) {
                var r = t.eq(n);
                m && (e[0] = f.call(this, n, r.html())), P(r, e, i, o)
            });
        if (h && (r = x(e, t[0].ownerDocument, !1, t, o), s = r.firstChild, 1 === r.childNodes.length && (r = s), s || o)) {
            for (l = (a = ft.map(y(r, "script"), E)).length; d < h; d++)
                c = r, d !== p && (c = ft.clone(c, !0, !0), l && ft.merge(a, y(c, "script"))), i.call(t[d], c, d);
            if (l)
                for (u = a[a.length - 1].ownerDocument, ft.map(a, S), d = 0; d < l; d++)
                    c = a[d], Xt.test(c.type || "") && !Mt.access(c, "globalEval") && ft.contains(u, c) && (c.src ? ft._evalUrl && ft._evalUrl(c.src) : n(c.textContent.replace(ie, ""), u))
        }
        return t
    }
    function A(t, e, n) {
        for (var i, o = e ? ft.filter(e, t) : t, r = 0; null != (i = o[r]); r++)
            n || 1 !== i.nodeType || ft.cleanData(y(i)), i.parentNode && (n && ft.contains(i.ownerDocument, i) && w(y(i, "script")), i.parentNode.removeChild(i));
        return t
    }
    function D(t, e, n) {
        var i,
            ...
            s,
            a = t.style;
        return (n = n || se(t)) && ("" !== (s = n.getPropertyValue(e) || n[e]) || ft.contains(t.ownerDocument, t) || (s = ft.style(t, e)), !ht.pixelMarginRight() && re.test(s) && oe.test(e) && (i = a.width, o = a.minWidth, r = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = o, a.maxWidth = r)), void 0 !== s ? s + "" : s
    }
    function N(t, e) {
        return {
            get: function() {
    ...
    function O(t, e, n, i, o) {
        ...
        for (r = n === (i ? "border" : "content") ? 4 : "width" === e ? 1 : 0; r < 4; r += 2)
            "margin" === n && (s += ft.css(t, n + qt[r], !0, o)), i ? ("content" === n && (s -= ft.css(t, "padding" + qt[r], !0, o)), "margin" !== n && (s -= ft.css(t, "border" + qt[r] + "Width", !0, o))) : (s += ft.css(t, "padding" + qt[r], !0, o), "padding" !== n && (s += ft.css(t, "border" + qt[r] + "Width", !0, o)));
        return s
    }
    function L(t, e, n) {
        var i,
        ...
        return re.test(r) ? r : (i = s && (ht.boxSizingReliable() || r === t.style[e]), "auto" === r && (r = t["offset" + e[0].toUpperCase() + e.slice(1)]), (r = parseFloat(r) || 0) + O(t, e, n || (s ? "border" : "content"), i, o) + "px")
    }
    function F(t, e, n, i, o) {
        return new F.prototype.init(t, e, n, i, o)
    }
    function q() {
        fe && (!1 === et.hidden && t.requestAnimationFrame ? t.requestAnimationFrame(q) : t.setTimeout(q, ft.fx.interval), ft.fx.tick())
    }
    function H() {
    ...
    function B(t, e) {
        var n,
            ...
            s;
        for (n in t)
            if (i = ft.camelCase(n), o = e[i], r = t[n], Array.isArray(r) && (o = r[1], r = t[n] = r[0]), n !== i && (t[i] = r, delete t[n]), (s = ft.cssHooks[i]) && "expand" in s) {
    ...
    function U(t, e, n) {
        var i,
            ...
            l = function() {
                if (o)
                    return !1;
                for (var e = pe || H(), n = Math.max(0, c.startTime + c.duration - e), i = 1 - (n / c.duration || 0), r = 0, s = c.tweens.length; r < s; r++)
                    c.tweens[r].run(i);
        ...
        for (B(u, c.opts.specialEasing); r < s; r++)
            if (i = U.prefilters[r].call(c, t, u, c.opts))
    ...
    ft.fn = ft.prototype = {
        ...
        for ("boolean" == typeof s && (c = s, s = arguments[a] || {}, a++), "object" == typeof s || ft.isFunction(s) || (s = {}), a === l && (s = this, a--); a < l; a++)
            if (null != (t = arguments[a]))
                for (e in t)
                    n = s[e], i = t[e], s !== i && (c && i && (ft.isPlainObject(i) || (o = Array.isArray(i))) ? (o ? (o = !1, r = n && Array.isArray(n) ? n : []) : r = n && ft.isPlainObject(n) ? n : {}, s[e] = ft.extend(c, r, i)) : void 0 !== i && (s[e] = i));
        return s
    }, ft.extend({
        ...
        isPlainObject: function(t) {
            var e,
                n;
            return !(!t || "[object Object]" !== lt.call(t) || (e = nt(t)) && ("function" != typeof (n = ct.call(e, "constructor") && e.constructor) || ut.call(n) !== dt))
        },
        ...
        proxy: function(t, e) {
            var n,
                i,
                o;
            if ("string" == typeof e && (n = t[e], e = t, t = n), ft.isFunction(t))
                return i = it.call(arguments, 2), o = function() {
    ...
    var wt = function(t) {
        function e(t, e, n, i) {
            var o,
                ...
                p = e && e.ownerDocument,
                f = e ? e.nodeType : 9;
            if (n = n || [], "string" != typeof t || !t || 1 !== f && 9 !== f && 11 !== f)
                return n;
            if (!i && ((e ? e.ownerDocument || e : F) !== A && P(e), e = e || A, N)) {
                if (11 !== f && (l = mt.exec(t)))
                    if (o = l[1]) {
                        if (9 === f) {
                            ...
                            if (s.id === o)
                                return n.push(s), n
                        } else if (p && (s = p.getElementById(o)) && O(e, s) && s.id === o)
                            return n.push(s), n
                    } else {
                        if (l[2])
                ...
                if (x.qsa && !B[t + " "] && (!M || !M.test(t))) {
                    if (1 !== f)
                        p = e, h = t;
                    else if ("object" !== e.nodeName.toLowerCase()) {
                        for ((a = e.getAttribute("id")) ? a = a.replace(wt, xt) : e.setAttribute("id", a = L), r = (u = T(t)).length; r--;)
                            u[r] = "#" + a + " " + d(u[r]);
                        h = u.join(","), p = gt.test(t) && c(e.parentNode) || e
                    }
                    if (h)
                        try {
        ...
        function h(t, e, n) {
            ...
            return e.first ? function(e, n, o) {
                ...
                if (l) {
                    ...
                    for (; e = e[i];)
                        if (1 === e.nodeType || s)
                            if (d = e[L] || (e[L] = {}), u = d[e.uniqueID] || (d[e.uniqueID] = {}), o && o === e.nodeName.toLowerCase())
                                e = e[i] || e;
                            else {
        ...
        function g(t, e, n, o, r, s) {
            return o && !o[L] && (o = g(o)), r && !r[L] && (r = g(r, s)), i(function(i, s, a, l) {
                var c,
                    u,
                    d,
                    h = [],
                    ...
                    w = n ? r || (i ? t : g || o) ? [] : s : y;
                if (n && n(y, w, a, l), o)
                    for (c = m(w, p), o(c, [], a, l), u = c.length; u--;)
                        (d = c[u]) && (w[p[u]] = !(y[p[u]] = d));
                if (i) {
                    if (r || t) {
                        if (r) {
                        ...
                        for (u = w.length; u--;)
                            (d = w[u]) && (c = r ? G(i, d) : h[u]) > -1 && (i[c] = !(s[c] = d))
                    }
                } else
                    w = m(w === s ? w.splice(g, w.length) : w), r ? r(null, s, w, l) : K.apply(s, w)
            })
        }
        function v(t) {
            for (var e, n, i, o = t.length, r = b.relative[t[0].type], s = r || b.relative[" "], a = r ? 1 : 0, l = h(function(t) {
                    return t === e
                }, s, !0), c = h(function(t) {
                    return G(e, t) > -1
                ...
                if (n = b.relative[t[a].type])
                    ...
                    if ((n = b.filter[t[a].type].apply(null, t[a].matches))[L]) {
                        for (i = ++a; i < o && !b.relative[t[i].type]; i++)
                            ;
                        return g(a > 1 && p(u), a > 1 && d(t.slice(0, a - 1).concat({
                            value: " " === t[a - 2].type ? "*" : ""
                        })).replace(rt, "$1"), n, a < i && v(t.slice(a, i)), i < o && v(t = t.slice(i)), i < o && d(t))
                    }
                    u.push(n)
                }
            return p(u)
            ...
            var o = n.length > 0,
                ...
                s = function(i, s, a, l, c) {
                    var u,
                        ...
                        _ = w.length;
                    for (c && (S = s === A || s || c); f !== _ && null != (u = w[f]); f++) {
                        if (r && u) {
                            for (d = 0, s || u.ownerDocument === A || (P(u), a = !N); h = t[d++];)
                                if (h(u, s || A, a)) {
                                    l.push(u);
                                    break
                                }
        ...
        x = e.support = {}, C = e.isXML = function(t) {
            ...
            return i !== A && 9 === i.nodeType && i.documentElement ? (A = i, D = A.documentElement, N = !C(A), F !== A && (n = A.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", bt, !1) : n.attachEvent && n.attachEvent("onunload", bt)), x.attributes = o(function(t) {
                return t.className = "i", !t.getAttribute("className")
            }), x.getElementsByTagName = o(function(t) {
                return t.appendChild(A.createComment("")), !t.getElementsByTagName("*").length
            }), x.getElementsByClassName = ft.test(A.getElementsByClassName), x.getById = o(function(t) {
            ...
            }, I = [], M = [], (x.qsa = ft.test(A.querySelectorAll)) && (o(function(t) {
            ...
            })), (x.matchesSelector = ft.test(z = D.matches || D.webkitMatchesSelector || D.mozMatchesSelector || D.oMatchesSelector || D.msMatchesSelector)) && o(function(t) {
                x.disconnectedMatch = z.call(t, "*"), z.call(t, "[s!='']:x"), I.push("!=", it)
            }), M = M.length && new RegExp(M.join("|")), I = I.length && new RegExp(I.join("|")), e = ft.test(D.compareDocumentPosition), O = e || ft.test(D.contains) ? function(t, e) {
                ...
                return n || (1 & (n = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1) || !x.sortDetached && e.compareDocumentPosition(t) === n ? t === A || t.ownerDocument === F && O(F, t) ? -1 : e === A || e.ownerDocument === F && O(F, e) ? 1 : $ ? G($, t) - G($, e) : 0 : 4 & n ? -1 : 1)
            } : function(t, e) {
                if (t === e)
                    return j = !0, 0;
                var n,
                    ...
                    l = [e];
                if (!o || !r)
                    return t === A ? -1 : e === A ? 1 : o ? -1 : r ? 1 : $ ? G($, t) - G($, e) : 0;
                if (o === r)
                    return s(t, e);
            ...
            if ((t.ownerDocument || t) !== A && P(t), n = n.replace(lt, "='$1']"), x.matchesSelector && N && !B[n + " "] && (!I || !I.test(n)) && (!M || !M.test(n)))
                try {
                    var i = z.call(t, n);
            ...
            var n = b.attrHandle[e.toLowerCase()],
                i = n && X.call(b.attrHandle, e.toLowerCase()) ? n(t, e, !N) : void 0;
            ...
            var e,
                ...
                i = 0,
                o = 0;
            if (j = !x.detectDuplicates, $ = !x.sortStable && t.slice(0), t.sort(U), j) {
                for (; e = t[o++];)
                    e === t[o] && (i = n.push(o));
                for (; i--;)
                    t.splice(n[i], 1)
            ...
            filter: {
                    ...
                    return 1 === i && 0 === o ? function(t) {
                        ...
                        if (g) {
                            ...
                            if (f = [s ? g.firstChild : g.lastChild], s && y) {
                                for (w = (p = (c = (u = (d = (h = g)[L] || (h[L] = {}))[h.uniqueID] || (d[h.uniqueID] = {}))[t] || [])[0] === q && c[1]) && c[2], h = p && g.childNodes[p]; h = ++p && h && h[m] || (w = p = 0) || f.pop();)
                                    if (1 === h.nodeType && ++w && h === e) {
                                        u[t] = [q, p, w];
                                        break
                                    }
                            } else if (y && (h = e, d = h[L] || (h[L] = {}), u = d[h.uniqueID] || (d[h.uniqueID] = {}), c = u[t] || [], p = c[0] === q && c[1], w = p), !1 === w)
                                for (; (h = ++p && h && h[m] || (w = p = 0) || f.pop()) && ((a ? h.nodeName.toLowerCase() !== v : 1 !== h.nodeType) || !++w || (y && (d = h[L] || (h[L] = {}), u = d[h.uniqueID] || (d[h.uniqueID] = {}), u[t] = [q, w]), h !== e));)
                                    ;
                ...
                PSEUDO: function(t, n) {
                    ...
                    return r[L] ? r(n) : r.length > 1 ? (o = [t, t, "", n], b.setFilters.hasOwnProperty(t.toLowerCase()) ? i(function(t, e) {
                        for (var i, o = r(t, n), s = o.length; s--;)
                            i = G(t, o[s]), t[i] = !(e[i] = o[s])
                    }) : function(t) {
                        return r(t, 0, o)
                    }) : r
                }
        ...
        return u.prototype = b.filters = b.pseudos, b.setFilters = new u, T = e.tokenize = function(t, n) {
            ...
            if (n = n || [], 1 === h.length) {
                if ((r = h[0] = h[0].slice(0)).length > 2 && "ID" === (s = r[0]).type && 9 === e.nodeType && N && b.relative[r[1].type]) {
                    if (!(e = (b.find.ID(s.matches[0].replace(vt, yt), e) || [])[0]))
                        return n;
                    u && (e = e.parentNode), t = t.slice(r.shift().value.length)
                }
                for (o = dt.needsContext.test(t) ? 0 : r.length; o-- && (s = r[o], !b.relative[a = s.type]);)
                    if ((l = b.find[a]) && (i = l(s.matches[0].replace(vt, yt), gt.test(r[0].type) && c(e.parentNode) || e))) {
                        if (r.splice(o, 1), !(t = i.length && d(r)))
                            return K.apply(n, i), n;
                        break
                    }
            }
            return (u || k(t, h))(i, e, !N, n, !e || gt.test(t) && c(e.parentNode) || e), n
        }, x.sortStable = L.split("").sort(U).join("") === L, x.detectDuplicates = !!j, P(), x.sortDetached = o(function(t) {
    ...
    (ft.fn.init = function(t, e, n) {
        ...
        if (n = n || kt, "string" == typeof t) {
            if (!(i = "<" === t[0] && ">" === t[t.length - 1] && t.length >= 3 ? [null, t, null] : Et.exec(t)) || !i[1] && e)
    ...
    ft.fn.extend({
        ...
        ft.fn[t] = function(n, i) {
            ...
            return "Until" !== t.slice(-5) && (i = n), i && "string" == typeof i && (o = ft.filter(i, o)), this.length > 1 && ($t[t] || ft.uniqueSort(o), St.test(t) && o.reverse()), this.pushStack(o)
        }
    });
    var jt = /[^\x20\t\r\n\f]+/g;
    ft.Callbacks = function(t) {
                ...
                o = {
                    ...
                    then: function(e, i, o) {
                                ...
                                var a = this,
                                    ...
                                    d = function() {
                                        ...
                                        if (!(e < s)) {
                                            ...
                                            d = t && ("object" == typeof t || "function" == typeof t) && t.then, ft.isFunction(d) ? o ? d.call(t, r(s, n, l, o), r(s, n, c, o)) : (s++, d.call(t, r(s, n, l, o), r(s, n, c, o), r(s, n, l, n.notifyWith))) : (i !== l && (a = void 0, u = [t]), (o || n.resolveWith)(a, u))
                                        }
                                    },
                                    h = o ? d : function() {
                                        try {
                                            ...
                                            ft.Deferred.exceptionHook && ft.Deferred.exceptionHook(t, h.stackTrace), e + 1 >= s && (i !== c && (a = void 0, u = [t]), n.rejectWith(a, u))
                                        }
                                    };
                        ...
                        return ft.Deferred(function(t) {
                            n[0][3].add(r(0, t, ft.isFunction(o) ? o : l, t.notifyWith)), n[1][3].add(r(0, t, ft.isFunction(e) ? e : l)), n[2][3].add(r(0, t, ft.isFunction(i) ? i : c))
                        }).promise()
                    },
                    promise: function(t) {
        ...
        when: function(t) {
            ...
            if (e <= 1 && (u(t, r.done(s(n)).resolve, r.reject, !e), "pending" === r.state() || ft.isFunction(o[n] && o[n].then)))
                return r.then();
            for (; n--;)
                u(o[n], s(n), r.reject);
            return r.promise()
    ...
    }), ft.ready.then = At.then, "complete" === et.readyState || "loading" !== et.readyState && !et.documentElement.doScroll ? t.setTimeout(ft.ready) : (et.addEventListener("DOMContentLoaded", d), t.addEventListener("load", d));
    ...
    h.uid = 1, h.prototype = {
        ...
        remove: function(t, e) {
            ...
            if (void 0 !== i) {
                if (void 0 !== e) {
                    Array.isArray(e) ? e = e.map(ft.camelCase) : (e = ft.camelCase(e), e = e in i ? [e] : e.match(jt) || []), n = e.length;
                    for (; n--;)
                        delete i[e[n]]
                }
    ...
    ft.extend({
        hasData: function(t) {
            return It.hasData(t) || Mt.hasData(t)
        },
        data: function(t, e, n) {
        ...
        data: function(t, e) {
            var n,
                ...
                s = r && r.attributes;
            if (void 0 === t) {
                if (this.length && (o = It.get(r), 1 === r.nodeType && !Mt.get(r, "hasDataAttrs"))) {
                    for (n = s.length; n--;)
                        s[n] && 0 === (i = s[n].name).indexOf("data-") && (i = ft.camelCase(i.slice(5)), f(r, i, o[i]));
        ...
        queue: function(t, e, n) {
            var i;
            if (t)
                return e = (e || "fx") + "queue", i = Mt.get(t, e), n && (!i || Array.isArray(n) ? i = Mt.access(t, e, ft.makeArray(n)) : i.push(n)), i || []
        },
        ...
        promise: function(t, e) {
            ...
            for ("string" != typeof t && (e = t, t = void 0), t = t || "fx"; s--;)
                (n = Mt.get(r[s], t + "queueHooks")) && n.empty && (i++, n.empty.add(a));
    ...
    ft.event = {
        ...
        add: function(t, e, n, i, o) {
            var r,
                ...
                g = Mt.get(t);
            if (g)
                for (n.handler && (r = n, n = r.handler, o = r.selector), o && ft.find.matchesSelector(Zt, o), n.guid || (n.guid = ft.guid++), (l = g.events) || (l = g.events = {}), (s = g.handle) || (s = g.handle = function(e) {
                    return void 0 !== ft && ft.event.triggered !== e.type ? ft.event.dispatch.apply(t, arguments) : void 0
                }), c = (e = (e || "").match(jt) || [""]).length; c--;)
                    a = Gt.exec(e[c]) || [], p = m = a[1], f = (a[2] || "").split(".").sort(), p && (d = ft.event.special[p] || {}, p = (o ? d.delegateType : d.bindType) || p, d = ft.event.special[p] || {}, u = ft.extend({
                        type: p,
                        origType: m,
                        data: i,
                        handler: n,
                        ...
                        namespace: f.join(".")
                    }, r), (h = l[p]) || (h = l[p] = [], h.delegateCount = 0, d.setup && !1 !== d.setup.call(t, i, f, s) || t.addEventListener && t.addEventListener(p, s)), d.add && (d.add.call(t, u), u.handler.guid || (u.handler.guid = n.guid)), o ? h.splice(h.delegateCount++, 0, u) : h.push(u), ft.event.global[p] = !0)
        },
            ...
            if (g && (l = g.events)) {
                for (c = (e = (e || "").match(jt) || [""]).length; c--;)
                    if (a = Gt.exec(e[c]) || [], p = m = a[1], f = (a[2] || "").split(".").sort(), p) {
                        for (d = ft.event.special[p] || {}, h = l[p = (i ? d.delegateType : d.bindType) || p] || [], a = a[2] && new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = r = h.length; r--;)
                        ...
                        s && !h.length && (d.teardown && !1 !== d.teardown.call(t, f, g.handle) || ft.removeEvent(t, p, g.handle), delete l[p])
                    } else
                        for (p in l)
                            ft.event.remove(t, p + e[c], n, i, !0);
        ...
        dispatch: function(t) {
            var e,
                ...
                c = (Mt.get(this, "events") || {})[a.type] || [],
                u = ft.event.special[a.type] || {};
            for (l[0] = a, e = 1; e < arguments.length; e++)
                l[e] = arguments[e];
            if (a.delegateTarget = this, !u.preDispatch || !1 !== u.preDispatch.call(this, a)) {
                for (s = ft.event.handlers.call(this, a, c), e = 0; (o = s[e++]) && !a.isPropagationStopped();)
                    for (a.currentTarget = o.elem, n = 0; (r = o.handlers[n++]) && !a.isImmediatePropagationStopped();)
                        a.rnamespace && !a.rnamespace.test(r.namespace) || (a.handleObj = r, a.data = r.data, void 0 !== (i = ((ft.event.special[r.origType] || {}).handle || r.handler).apply(o.elem, l)) && !1 === (a.result = i) && (a.preventDefault(), a.stopPropagation()));
            ...
            if (l && c.nodeType && !("click" === t.type && t.button >= 1))
                for (; c !== this; c = c.parentNode || this)
                    if (1 === c.nodeType && ("click" !== t.type || !0 !== c.disabled)) {
                        for (r = [], s = {}, n = 0; n < l; n++)
                            i = e[n], o = i.selector + " ", void 0 === s[o] && (s[o] = i.needsContext ? ft(o, this).index(c) > -1 : ft.find(o, this, null, [c]).length), s[o] && r.push(i);
                        r.length && a.push({
                            elem: c,
                            handlers: r
                        })
        ...
        return this instanceof ft.Event ? (t && t.type ? (this.originalEvent = t, this.type = t.type, this.isDefaultPrevented = t.defaultPrevented || void 0 === t.defaultPrevented && !1 === t.returnValue ? b : _, this.target = t.target && 3 === t.target.nodeType ? t.target.parentNode : t.target, this.currentTarget = t.currentTarget, this.relatedTarget = t.relatedTarget) : this.type = t, e && ft.extend(this, e), this.timeStamp = t && t.timeStamp || ft.now(), void (this[ft.expando] = !0)) : new ft.Event(t, e)
    }, ft.Event.prototype = {
        ...
        which: function(t) {
            var e = t.button;
            return null == t.which && Kt.test(t.type) ? null != t.charCode ? t.charCode : t.keyCode : !t.which && void 0 !== e && Yt.test(t.type) ? 1 & e ? 1 : 2 & e ? 3 : 4 & e ? 2 : 0 : t.which
        }
    ...
    ft.extend({
        ...
        clone: function(t, e, n) {
            ...
            if (!(ht.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || ft.isXMLDoc(t)))
                for (s = y(a), r = y(t), i = 0, o = r.length; i < o; i++)
                    j(r[i], s[i]);
            if (e)
                if (n)
                    for (r = r || y(t), s = s || y(a), i = 0, o = r.length; i < o; i++)
                        $(r[i], s[i]);
                else
                    $(t, a);
            return (s = y(a, "script")).length > 0 && w(s, !l && y(t, "script")), a
        },
        ...
        html: function(t) {
            return Dt(this, function(t) {
                ...
                if (void 0 === t && 1 === e.nodeType)
                    return e.innerHTML;
                if ("string" == typeof t && !te.test(t) && !Qt[(Ut.exec(t) || ["", ""])[1].toLowerCase()]) {
                    t = ft.htmlPrefilter(t);
                    try {
                        for (; n < i; n++)
                            1 === (e = this[n] || {}).nodeType && (ft.cleanData(y(e, !1)), e.innerHTML = t);
                        e = 0
                    } catch (t) {}
                }
        ...
        ft.fn[t] = function(t) {
            for (var n, i = [], o = ft(t), r = o.length - 1, s = 0; s <= r; s++)
                n = s === r ? this : this.clone(!0), ft(o[s])[e](n), rt.apply(i, n.get());
            return this.pushStack(i)
        }
    });
    var oe = /^margin/,
        re = new RegExp("^(" + Lt + ")(?!px)[a-z%]+$", "i"),
        se = function(e) {
    ...
    !function() {
        function e() {
            if (a) {
                ...
                n = "1%" !== e.top, r = "2px" === e.marginLeft, i = "4px" === e.width, a.style.marginRight = "50%", o = "4px" === e.marginRight, Zt.removeChild(s), a = null
            }
        }
        var n,
            i,
        ...
        a.style && (a.style.backgroundClip = "content-box", a.cloneNode(!0).style.backgroundClip = "", ht.clearCloneStyle = "content-box" === a.style.backgroundClip, s.style.cssText = "border:0;width:8px;height:0;top:0;left:-9999px;padding:0;margin-top:1px;position:absolute", s.appendChild(a), ft.extend(ht, {
    ...
    ft.extend({
        ...
        css: function(t, e, n, i) {
            var o,
                ...
                s,
                a = ft.camelCase(e);
            return le.test(e) || (e = I(a)), (s = ft.cssHooks[e] || ft.cssHooks[a]) && "get" in s && (o = s.get(t, !0, n)), void 0 === o && (o = D(t, e, i)), "normal" === o && e in ue && (o = ue[e]), "" === n || n ? (r = parseFloat(o), !0 === n || isFinite(r) ? r || 0 : o) : o
        }
    }), ft.each(["height", "width"], function(t, e) {
        ft.cssHooks[e] = {
            get: function(t, n, i) {
                if (n)
                    return !ae.test(ft.css(t, "display")) || t.getClientRects().length && t.getBoundingClientRect().width ? L(t, e, i) : Rt(t, ce, function() {
                        return L(t, e, i)
                    })
            },
            set: function(t, n, i) {
                var o,
                    r = i && se(t),
                    s = i && O(t, e, i, "border-box" === ft.css(t, "boxSizing", !1, r), r);
                return s && (o = Ft.exec(n)) && "px" !== (o[3] || "px") && (t.style[e] = n, n = ft.css(t, e)), z(0, n, s)
            }
        }
    }), ft.cssHooks.marginLeft = N(ht.reliableMarginLeft, function(t, e) {
        if (e)
        ...
        }, oe.test(t) || (ft.cssHooks[t + e].set = z)
    }), ft.fn.extend({
        css: function(t, e) {
    ...
    ft.Animation = ft.extend(U, {
        ...
        prefilters: [function(t, e, n) {
            var i,
                ...
                m = t.nodeType && Ht(t),
                g = Mt.get(t, "fxshow");
            n.queue || (null == (s = ft._queueHooks(t, "fx")).unqueued && (s.unqueued = 0, a = s.empty.fire, s.empty.fire = function() {
                s.unqueued || a()
            ...
            if ((l = !ft.isEmptyObject(e)) || !ft.isEmptyObject(p)) {
                d && 1 === t.nodeType && (n.overflow = [f.overflow, f.overflowX, f.overflowY], null == (c = g && g.display) && (c = Mt.get(t, "display")), "none" === (u = ft.css(t, "display")) && (c ? u = c : (v([t], !0), c = t.style.display || c, u = ft.css(t, "display"), v([t]))), ("inline" === u || "inline-block" === u && null != c) && "none" === ft.css(t, "float") && (l || (h.done(function() {
                    f.display = c
                }), null == c && (u = f.display, c = "none" === u ? "" : u)), f.display = "inline-block")), n.overflow && (f.overflow = "hidden", h.always(function() {
                    f.overflow = n.overflow[0], f.overflowX = n.overflow[1], f.overflowY = n.overflow[2]
                })), l = !1;
                for (i in p)
                    l || (g ? "hidden" in g && (m = g.hidden) : g = Mt.access(t, "fxshow", {
                        display: c
                    }), r && (g.hidden = !m), m && v([t], !0), h.done(function() {
                        m || v([t]), Mt.remove(t, "fxshow");
                        for (i in p)
                            ft.style(t, i, p[i])
                    })), l = W(m ? g[i] : 0, i, h), i in g || (g[i] = l.start, m && (l.end = l.start, l.start = 0))
            }
        }],
    ...
    ft.fn.extend({
        ...
        attr: function(t, e, n) {
            var i,
                ...
                r = t.nodeType;
            if (3 !== r && 8 !== r && 2 !== r)
                return void 0 === t.getAttribute ? ft.prop(t, e, n) : (1 === r && ft.isXMLDoc(t) || (o = ft.attrHooks[e.toLowerCase()] || (ft.expr.match.bool.test(e) ? ve : void 0)), void 0 !== n ? null === n ? void ft.removeAttr(t, e) : o && "set" in o && void 0 !== (i = o.set(t, n, e)) ? i : (t.setAttribute(e, n + ""), n) : o && "get" in o && null !== (i = o.get(t, e)) ? i : null == (i = ft.find.attr(t, e)) ? void 0 : i)
        },
        attrHooks: {
            type: {
                set: function(t, e) {
        ...
        toggleClass: function(t, e) {
            ...
            return "boolean" == typeof e && "string" === n ? e ? this.addClass(t) : this.removeClass(t) : ft.isFunction(t) ? this.each(function(n) {
                ...
                var e,
                    ...
                    r;
                if ("string" === n)
                    for (i = 0, o = ft(this), r = t.match(jt) || []; e = r[i++];)
                        o.hasClass(e) ? o.removeClass(e) : o.addClass(e);
                else
                    void 0 !== t && "boolean" !== n || ((e = Q(this)) && Mt.set(this, "__className__", e), this.setAttribute && this.setAttribute("class", e || !1 === t ? "" : Mt.get(this, "__className__") || ""))
            })
        },
        hasClass: function(t) {
            var e,
    ...
    ft.fn.extend({
        val: function(t) {
            ...
            })) : o ? (e = ft.valHooks[o.type] || ft.valHooks[o.nodeName.toLowerCase()]) && "get" in e && void 0 !== (n = e.get(o, "value")) ? n : "string" == typeof (n = o.value) ? n.replace(be, "") : null == n ? "" : n : void 0
        }
    }), ft.extend({
        valHooks: {
            option: {
            ...
            select: {
                ...
                set: function(t, e) {
                    for (var n, i, o = t.options, r = ft.makeArray(e), s = o.length; s--;)
                        i = o[s], (i.selected = ft.inArray(ft.valHooks.option.get(i), r) > -1) && (n = !0);
    ...
    ft.extend(ft.event, {
        trigger: function(e, n, i, o) {
            ...
            if (s = a = i = i || et, 3 !== i.nodeType && 8 !== i.nodeType && !_e.test(p + ft.event.triggered) && (p.indexOf(".") > -1 && (f = p.split("."), p = f.shift(), f.sort()), c = p.indexOf(":") < 0 && "on" + p, e = e[ft.expando] ? e : new ft.Event(p, "object" == typeof e && e), e.isTrigger = o ? 2 : 3, e.namespace = f.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = i), n = null == n ? [e] : ft.makeArray(n, [e]), d = ft.event.special[p] || {}, o || !d.trigger || !1 !== d.trigger.apply(i, n))) {
                if (!o && !d.noBubble && !ft.isWindow(i)) {
                    for (l = d.delegateType || p, _e.test(l + p) || (s = s.parentNode); s; s = s.parentNode)
                        h.push(s), a = s;
                    a === (i.ownerDocument || et) && h.push(a.defaultView || a.parentWindow || t)
                }
                for (r = 0; (s = h[r++]) && !e.isPropagationStopped();)
                    e.type = r > 1 ? l : d.bindType || p, (u = (Mt.get(s, "events") || {})[e.type] && Mt.get(s, "handle")) && u.apply(s, n), (u = c && s[c]) && u.apply && Nt(s) && (e.result = u.apply(s, n), !1 === e.result && e.preventDefault());
                return e.type = p, o || e.isDefaultPrevented() || d._default && !1 !== d._default.apply(h.pop(), n) || !Nt(i) || c && ft.isFunction(i[p]) && !ft.isWindow(i) && ((a = i[c]) && (i[c] = null), ft.event.triggered = p, i[p](), ft.event.triggered = void 0, a && (i[c] = a)), e.result
            }
        },
    ...
    }), ht.focusin = "onfocusin" in t, ht.focusin || ft.each({
        focus: "focusin",
        blur: "focusout"
    }, function(t, e) {
        var n = function(t) {
    ...
    ft.param = function(t, e) {
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var t = this.type;
                return this.name && !ft(this).is(":disabled") && je.test(this.nodeName) && !$e.test(t) && (this.checked || !Bt.test(t))
            }).map(function(t, e) {
                var n = ft(this).val();
    ...
    Fe.href = Ce.href, ft.extend({
        ...
        ajax: function(e, n) {
            ...
            if (v.promise(C), f.url = ((e || f.url || Ce.href) + "").replace(Ie, Ce.protocol + "//"), f.type = n.method || n.type || f.method || f.type, f.dataTypes = (f.dataType || "*").toLowerCase().match(jt) || [""], null == f.crossDomain) {
            ...
            if (f.data && f.processData && "string" != typeof f.data && (f.data = ft.param(f.data, f.traditional)), K(ze, f, n, C), u)
                return C;
            (d = ft.event && f.global) && 0 == ft.active++ && ft.event.trigger("ajaxStart"), f.type = f.type.toUpperCase(), f.hasContent = !Me.test(f.type), r = f.url.replace(Ae, ""), f.hasContent ? f.data && f.processData && 0 === (f.contentType || "").indexOf("application/x-www-form-urlencoded") && (f.data = f.data.replace(Pe, "+")) : (p = f.url.slice(r.length), f.data && (r += (ke.test(r) ? "&" : "?") + f.data, delete f.data), !1 === f.cache && (r = r.replace(De, "$1"), p = (ke.test(r) ? "&" : "?") + "_=" + Te++ + p), f.url = r + p), f.ifModified && (ft.lastModified[r] && C.setRequestHeader("If-Modified-Since", ft.lastModified[r]), ft.etag[r] && C.setRequestHeader("If-None-Match", ft.etag[r])), (f.data && f.hasContent && !1 !== f.contentType || n.contentType) && C.setRequestHeader("Content-Type", f.contentType), C.setRequestHeader("Accept", f.dataTypes[0] && f.accepts[f.dataTypes[0]] ? f.accepts[f.dataTypes[0]] + ("*" !== f.dataTypes[0] ? ", " + Le + "; q=0.01" : "") : f.accepts["*"]);
            for (h in f.headers)
                C.setRequestHeader(h, f.headers[h]);
            if (f.beforeSend && (!1 === f.beforeSend.call(m, C, f) || u))
                return C.abort();
            if (_ = "abort", y.add(f.complete), C.done(f.success), C.fail(f.error), o = K(Oe, f, n, C)) {
    ...
    ht.cors = !!He && "withCredentials" in He, ht.ajax = He = !!He, ft.ajaxTransport(function(e) {
        var n,
            i;
        if (ht.cors || He && !e.crossDomain)
            return {
                send: function(o, r) {
                    var s,
                        a = e.xhr();
    ...
    ft.ajaxSetup({
        ...
        if (a || "jsonp" === e.dataTypes[0])
            return o = e.jsonpCallback = ft.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, a ? e[a] = e[a].replace(We, "$1" + o) : !1 !== e.jsonp && (e.url += (ke.test(e.url) ? "&" : "?") + e.jsonp + "=" + o), e.converters["script json"] = function() {
                return s || ft.error(o + " was not called"), s[0]
            }, e.dataTypes[0] = "json", r = t[o], t[o] = function() {
                s = arguments
            }, i.always(function() {
                void 0 === r ? ft(t).removeProp(o) : t[o] = r, e[o] && (e.jsonpCallback = n.jsonpCallback, Re.push(o)), s && ft.isFunction(r) && r(s[0]), s = r = void 0
            }), "script"
        ...
        var i,
            o,
            r;
        return e || (ht.createHTMLDocument ? (e = et.implementation.createHTMLDocument(""), i = e.createElement("base"), e.head.appendChild(i)) : e = et), o = Ct.exec(t), r = !n && [], o ? [e.createElement(o[1])] : (o = x([t], e, r), r && r.length && ft(r).remove(), ft.merge([], o.childNodes))
        ...
        var i,
            ...
            s = this,
            a = t.indexOf(" ");
        return a > -1 && (i = X(t.slice(a)), t = t.slice(0, a)), ft.isFunction(e) ? (n = e, e = void 0) : e && "object" == typeof e && (o = "POST"), s.length > 0 && ft.ajax({
            url: t,
            type: o || "GET",
            dataType: "html",
            data: e
        ...
        ft.fn[t] = function(i) {
            return Dt(this, function(t, i, o) {
                var r;
                return ft.isWindow(t) ? r = t : 9 === t.nodeType && (r = t.defaultView), void 0 === o ? r ? r[e] : t[i] : void (r ? r.scrollTo(n ? r.pageXOffset : o, n ? o : r.pageYOffset) : t[i] = o)
            }, t, i, arguments.length)
        }
    }), ft.each(["top", "left"], function(t, e) {
        ft.cssHooks[e] = N(ht.pixelPosition, function(t, n) {
            if (n)
                return n = D(t, e), re.test(n) ? ft(t).position()[e] + "px" : n
        })
    }), ft.each({
        Height: "height",
        Width: "width"
    ...
    o.Defaults = {
        ...
        var n = this.current(),
            ...
            a = this.minimum(),
            l = this.maximum();
        this.settings.loop ? (!this.settings.rewind && Math.abs(o) > s / 2 && (o += -1 * r * s), t = n + o, (i = ((t - a) % s + s) % s + a) !== t && i - o <= l && i - o > 0 && (n = i - o, t = i, this.reset(n))) : this.settings.rewind ? (l += 1, t = (t % l + l) % l) : t = Math.max(a, Math.min(l, t)), this.speed(this.duration(n, t, e)), this.current(t), this.$element.is(":visible") && this.update()
    ...
    o.Defaults = {
        ...
        if (e.wrap('<div class="owl-video-wrapper"' + s + "></div>"), this._core.settings.lazyLoad && (l = "data-src", c = "owl-lazy"), a.length)
    ...
    v.prototype = {
        ...
        open: function(n) {
                ...
                e.items = t.isArray(n.items) ? n.items : [n.items], e.index = n.index || 0;
            {
                if (!e.isOpen) {
                    ...
                    _("BeforeOpen"), e.st.showCloseBtn && (e.st.closeBtnInside ? (x(c, function(t, e, n, i) {
                        ...
                        height: i.height(),
                        position: "absolute"
                    }), e.st.enableEscapeKey && i.on("keyup" + p, function(t) {
                    ...
                    return e.isIE7 && (v += " mfp-ie7"), v && e._addClassToMFP(v), e.updateItemHTML(), _("BuildControls"), t("html").css(m), e.bgOverlay.add(e.wrap).prependTo(e.st.prependTo || t(document.body)), e._lastFocusedEl = document.activeElement, setTimeout(function() {
                        e.content ? (e._addClassToMFP(f), e._setFocus()) : e.bgOverlay.addClass(f), i.on("focusin" + p, e._onFocusIn)
                    }, 16), e.isOpen = !0, e.updateSize(h), _(u), n
                }
                e.updateItemHTML()
            }
        },
        ...
        updateItemHTML: function() {
            ...
            e.appendContent(s, i), n.preloaded = !0, _(d, n), o = n.type, e.container.prepend(e.contentContainer), _("AfterChange")
        },
        ...
        parseEl: function(n) {
            ...
            return o.type = i || e.st.type || "inline", o.index = n, o.parsed = !0, e.items[n] = o, _("ElementParse", o), e.items[n]
        },
        ...
        updateStatus: function(t, i) {
            if (e.preloader) {
                ...
                _("UpdateStatus", o), t = o.status, i = o.text, e.preloader.html(i), e.preloader.find("a").on("click", function(t) {
        ...
        _parseMarkup: function(e, n, i) {
            var o;
            i.data && (n = t.extend(i.data, n)), _(c, [e, n, i]), t.each(n, function(n, i) {
                if (void 0 === i || !1 === i)
                    return !0;
        ...
        if ("string" == typeof n)
            ...
            n = t.extend(!0, {}, n), y ? i.data("magnificPopup", n) : i[0].magnificPopup = n, e.addGroup(i, n);
        return i
    };
    var E,
        S,
        ...
        j = "inline",
        P = function() {
            $ && (S.after($.addClass(E)).detach(), $ = null)
        };
            ...
            getInline: function(n, i) {
                if (P(), n.src) {
                    ...
                    if (r.length) {
                        ...
                        s && s.tagName && (S || (E = o.hiddenClass, S = b(E), E = "mfp-" + E), $ = r.after(S).detach().removeClass(E)), e.updateStatus("ready")
                    } else
            ...
            getAjax: function(n) {
                ...
                var i = t.extend({
                    ...
                    success: function(i, o, r) {
                        ...
                        _("ParseAjax", s), e.appendContent(t(s.data), D), n.finished = !0, N(), e._setFocus(), setTimeout(function() {
                            e.wrap.addClass(f)
        ...
        proto: {
            initImage: function() {
                ...
                e.types.push("image"), x(u + i, function() {
                    ...
                    n.cursor && t(document.body).removeClass(n.cursor), w.off("resize" + p)
                ...
                var n = 0,
                    ...
                    o = function(r) {
                        I && clearInterval(I), I = setInterval(function() {
                            return i.naturalWidth > 0 ? void e._onImageHasSize(t) : (n > 200 && clearInterval(I), void (3 === ++n ? o(10) : 40 === n ? o(50) : 100 === n && o(500)))
                        }, r)
                    };
                o(1)
            },
            getImage: function(n, i) {
                var o = 0,
                    r = function() {
                        n && (n.img[0].complete ? (n.img.off(".mfploader"), n === e.currItem && (e._onImageHasSize(n), e.updateStatus("ready")), n.hasSize = !0, n.loaded = !0, _("ImageLoadComplete")) : 200 > ++o ? setTimeout(r, 100) : s())
                    },
                    s = function() {
                ...
                if (l.length) {
                    ...
                    c.className = "mfp-img", n.el && n.el.find("img").length && (c.alt = n.el.find("img").attr("alt")), n.img = t(c).on("load.mfploader", r).on("error.mfploader", s), c.src = n.src, l.is("img") && (n.img = n.img.clone()), (c = n.img[0]).naturalWidth > 0 ? n.hasSize = !0 : c.width || (n.hasSize = !1)
                }
                return e._parseMarkup(i, {
                    title: z(n),
                    img_replaceWith: n.img
                }, n), e.resizeImage(), n.hasSize ? (I && clearInterval(I), n.loadError ? (i.addClass("mfp-loading"), e.updateStatus("error", a.tError.replace("%url%", n.src))) : (i.removeClass("mfp-loading"), e.updateStatus("ready")), i) : (e.updateStatus("loading"), n.loading = !0, n.hasSize || (n.imgHidden = !0, i.addClass("mfp-loading"), e.findImageSize(n)), i)
            }
        }
    });
    var O,
    ...
    t.magnificPopup.registerModule("zoom", {
        ...
        proto: {
            ...
            _getOffset: function(n) {
                ...
                return L() ? a["-moz-transform"] = a.transform = "translate(" + o.left + "px," + o.top + "px)" : (a.left = o.left, a.top = o.top), a
            }
        }
    });
    var F = "iframe",
    ...
    t.magnificPopup.registerModule("gallery", {
        ...
        proto: {
            initGallery: function() {
                var n = e.st.gallery,
                    o = ".mfp-gallery";
                return e.direction = !0, !(!n || !n.enabled) && (r += " mfp-gallery", x(u + o, function() {
                    n.navigateByImgClick && e.wrap.on("click" + o, ".mfp-img", function() {
                        return e.items.length > 1 ? (e.next(), !1) : void 0
                    }), i.on("keydown" + o, function(t) {
                        37 === t.keyCode ? e.prev() : 39 === t.keyCode && e.next()
                    })
                }), x("UpdateStatus" + o, function(t, n) {
                    n.text && (n.text = R(n.text, e.currItem.index, e.items.length))
                }), x(c + o, function(t, i, o, r) {
...
}), fotoramaVersion = "4.6.4", function(t, e, n, i, o) {
    "use strict";
    function r() {}
    function s(t, e, n) {
    ...
    function l(t) {
        return Ae ? +a(t.css("transform")) : +t.css("left").replace("px", "")
    }
    function c(t) {
        var e = {};
        return Ae ? e.transform = "translate3d(" + t + "px,0,0)" : e.left = t, e
    }
    function u(t) {
        return {
    ...
    function y(t) {
        ...
        if (!e.tEnd) {
            B(t[0], {
                ...
                transition: "transitionend"
            }[ve.prefixed("transition")], function(t) {
    ...
    function x(t, e) {
        if (t.length) {
            var n = t.data();
            Ae ? (t.css(u(0)), n.onEndFn = r, clearTimeout(n.tT)) : t.stop();
            var i = b(e, function() {
                return l(t)
            });
            return t.css(c(i)), i
    ...
    function k(t, e) {
        ...
        if ((t = T(t)).host.match(/youtube\.com/) && t.search) {
            ...
            t.host.match(/youtube\.com|youtu\.be/) ? (n = t.pathname.replace(/^\/(embed\/|v\/)?/, "").replace(/\/.*/, ""), i = "youtube") : t.host.match(/vimeo\.com/) && (i = "vimeo", n = t.pathname.replace(/^\/(video\/)?/, "").replace(/\/.*/, ""));
    ...
    function E(t, e, n) {
        var o,
            r,
            s = t.video;
        return "youtube" === s.type ? (r = C() + "img.youtube.com/vi/" + s.id + "/default.jpg", o = r.replace(/\/default.jpg$/, "/hqdefault.jpg"), t.thumbsReady = !0) : "vimeo" === s.type ? i.ajax({
            url: C() + "vimeo.com/api/v2/video/" + s.id + ".json",
            dataType: "jsonp",
            success: function(i) {
                t.thumbsReady = !0, S(e, {
    ...
    function S(t, e, n, o) {
        for (var r = 0, s = t.length; s > r; r++) {
            ...
            if (a.i === n && a.thumbsReady) {
                ...
                l[Ue] = l[Qe] = l[Xe] = !1, o.splice(r, 1, i.extend({}, a, l, e));
                break
            }
        }
    }
    function $(t) {
        ...
        function n(t, e, n) {
            var o = n.thumb && n.img !== n.thumb,
                ...
                s = h(n.height || t.attr("height"));
            i.extend(n, {
                width: r,
                height: s,
                thumbratio: W(n.thumbratio || h(n.thumbwidth || e && e.attr("width") || o || r) / h(n.thumbheight || e && e.attr("height") || o || s))
            })
        }
        var o = [];
    ...
    function A(t, e, n, i) {
        return A.i || (A.i = 1, A.ii = [!0]), i = i || A.i, void 0 === A.ii[i] && (A.ii[i] = !0), t() ? e() : A.ii[i] && setTimeout(function() {
            A.ii[i] && A(t, e, n, i)
        }, n || 100), A.i++
    }
    function D(t) {
    ...
    function N(t, e, n, i) {
        ...
        if (r && (!o.l || o.l.W !== r.width || o.l.H !== r.height || o.l.r !== r.ratio || o.l.w !== e.w || o.l.h !== e.h || o.l.m !== n || o.l.p !== i)) {
            var a = r.width,
                ...
                p = "cover" === n,
                m = Y(i);
            u && (d || h) || !u && p ? (a = s(e.w, 0, d ? a : 1 / 0), l = a / r.ratio) : (u && p || !u && (d || h)) && (l = s(e.h, 0, d ? l : 1 / 0), a = l * r.ratio), t.css({
                width: a,
                height: l,
                left: f(m.x, e.w - a),
                top: f(m.y, e.h - l)
    ...
    function O(t, e, n) {
        n = n || {}, t.each(function() {
            var t,
                o = i(this),
                s = o.data();
            s.clickOn || (s.clickOn = !0, i.extend(et(o, {
                onStart: function(e) {
    ...
    function Q(t, e) {
        B(t, "keyup", function(n) {
            U(t) || 13 == n.keyCode && e.call(t, n)
        })
    }
    function V(t, e) {
        B(t, "focus", t.onfocusin = function(n) {
            e.call(t, n)
        }, !0)
    }
    function Z(t, e) {
    ...
    function G(t, e) {
        ...
        void 0 !== e.overPos && e.overPos !== e.pos && (o = e.overPos, s = function() {
            G(t, i.extend({}, e, {
                overPos: e.pos,
                time: Math.max(Fe, e.time / 2)
            }))
        });
        var a = i.extend(c(o), e.width && {
            width: e.width
        });
        n.sliding = !0, Ae ? (t.css(i.extend(u(e.time), a)), e.time > 10 ? w(t, "transform", s, e.time) : s()) : t.stop().animate(a, e.time, Ze, s)
    }
    function J(t, e, n, o, s, a) {
        var l = void 0 !== a;
            ...
            var c = t[0],
                ...
                h = function() {
                    if (!h.done) {
                        ...
                        t && J.apply(this, t), (o.onEnd || r)(!!t)
                    }
                },
                p = o.time / (a || 1);
            n.removeClass(Rt + " " + Ht), t.stop().addClass(Rt), e.stop().addClass(Ht), d && u && t.fadeTo(0, 0), t.fadeTo(d ? p : 0, 1, d && h), e.fadeTo(p, 0, h), c && d || u || h()
        }
    }
    function tt(t) {
        var e = (t.touches || [])[0] || t;
    ...
    function et(t, n) {
        function o(t) {
            return d = i(t.target), w.checked = f = m = v = !1, c || w.flow || t.touches && t.touches.length > 1 || t.which > 1 || Je && Je.type !== t.type && en || (f = n.select && d.is(n.select, y)) ? f : (p = "touchstart" === t.type, m = d.is("a, a *", y), h = w.control, g = w.noMove || w.noSwipe || h ? 16 : w.snap ? 0 : 4, tt(t), u = Je = t, tn = t.type.replace(/down|start/, "move").replace(/Down/, "Move"), (n.onStart || r).call(y, t, {
                control: h,
                $target: d
            }), c = w.flow = !0, void ((!p || w.go) && Z(t)))
        }
        function s(t) {
            if (t.touches && t.touches.length > 1 || ze && !t.isPrimary || tn !== t.type || !c)
                return c && a(), void (n.onTouchEnd || r)();
            tt(t);
            var e = Math.abs(t._x - u._x),
                ...
                l = 0 > o;
            p && !w.checked ? (c = s) && Z(t) : (Z(t), (n.onMove || r).call(y, t, {
                touch: p
            })), !v && Math.sqrt(Math.pow(e, 2) + Math.pow(i, 2)) > g && (v = !0), w.checked = w.checked || s || l
        }
        function a(t) {
            (n.onTouchEnd || r)();
            var e = c;
            w.control = c = !1, e && (w.flow = !1), !e || m && !w.checked || (t && Z(t), en = !0, clearTimeout(nn), nn = setTimeout(function() {
                en = !1
        ...
        var c,
            ...
            y = t[0],
            w = {};
        return ze ? (B(y, "MSPointerDown", o), B(e, "MSPointerMove", s), B(e, "MSPointerCancel", a), B(e, "MSPointerUp", a)) : (B(y, "touchstart", o), B(y, "touchmove", s), B(y, "touchend", a), B(e, "touchstart", function() {
            w.flow || setTimeout(function() {
                w.flow = !0
            }, 10)
        }), B(e, "touchend", l), B(e, "touchcancel", l), Se.on("scroll", l), t.on("mousedown", o), $e.on("mousemove", s).on("mouseup", a)), t.on("click", "a", function(t) {
            w.checked && Z(t)
        }), w
    }
    function nt(t, e) {
        function n(n, i) {
            C = !0, o = a = n._x, p = n._now, h = [[p, o]], l = u = E.noMove || i ? 0 : x(t, (e.getPos || r)()), (e.onStart || r).call(T, n)
        }
        var o,
            a,
            l,
            ...
            k = t.data(),
            E = {};
        return E = i.extend(et(e.$wrap, i.extend({}, e, {
            onStart: function(t, e) {
                m = E.min, g = E.max, v = E.snap, y = t.altKey, C = b = !1, (w = e.control) || k.sliding || n(t)
            },
            onMove: function(i, s) {
                E.noSwipe || (C || n(i), a = i._x, h.push([i._now, a]), u = l - (o - a), d = I(u, m, g), m >= u ? u = _(u, m) : u >= g && (u = _(u, g)), E.noMove || (t.css(c(u)), b || (b = !0, s.touch || ze || t.addClass(ne)), (e.onMove || r).call(T, i, {
                    pos: u,
                    edge: d
                })))
            },
            onEnd: function(o) {
                if (!E.noSwipe || !o.moved) {
                    C || n(o.startEvent, !0), o.touch || ze || t.removeClass(ne);
                    for (var c, d, p, w, x, b, _, k, S, $ = (f = i.now()) - Le, j = null, P = Fe, A = e.friction, D = h.length - 1; D >= 0; D--) {
                        if (c = h[D][0], d = Math.abs(c - $), null === j || p > d)
                            j = c, w = h[D][1];
                        else if (j === $ || d > p)
                            break;
                        p = d
                    ...
                    var N = w - a,
                        ...
                        z = I > Le,
                        O = !z && u !== l && _ === u;
                    v && (_ = s(Math[O ? M ? "floor" : "ceil" : "round"](u / v) * v, m, g), m = g = _), O && (v || _ === u) && (S = -N / I, P *= s(Math.abs(S), e.timeLow, e.timeHigh), x = Math.round(u + S * P / A), v || (_ = x), (!M && x > g || M && m > x) && (b = M ? m : g, k = x - b, v || (_ = b), k = s(_ + .03 * k, b - 50, b + 50), P = Math.abs((u - k) / (S / A)))), P *= y ? 10 : 1, (e.onEnd || r).call(T, i.extend(o, {
                        moved: o.moved || z && v,
                        pos: u,
                        newPos: _,
                        overPos: k,
    ...
    function it(t, e) {
        ...
        return B(t[0], Oe, function(t) {
            var l = t.wheelDeltaY || -1 * t.deltaY || 0,
                ...
                p = i.now(),
                f = Le > p - s;
            o = d, s = p, u && a.ok && (!a.prevent[d] || n) && (Z(t, !0), n && h && f || (e.shift && (n = !0, clearTimeout(a.t), a.t = setTimeout(function() {
                n = !1
            }, qe)), (e.onEnd || r)(t, e.shift ? d : c)))
        }), a
    }
    function ot() {
    ...
    function rt(t) {
        i.Fotorama.instances.push(t), ot()
    }
    function st(t) {
        i.Fotorama.instances.splice(t.index, 1), ot()
    }
    var at = "fotorama",
        lt = "fullscreen",
        ct = at + "__wrap",
        ...
        de = ce + "-close",
        he = at + "__caption",
        pe = at + "__caption__wrap",
        fe = at + "__spinner",
        me = '" tabindex="0" role="button',
        ge = i && i.fn.jquery.split(".");
    if (!ge || ge[0] < 1 || 1 == ge[0] && ge[1] < 8)
    ...
    var ve = function(t, e, n) {
            ...
            function s(t, e, o) {
                for (var r in t) {
                    var s = e[t[r]];
                    if (s !== n)
                        return !1 === o ? t[r] : i(s, "function") ? s.bind(o || e) : s
                }
                return !1
            }
            function a(t, e, n) {
                ...
                return i(e, "string") || i(e, "undefined") ? r(a, e) : (a = (t + " " + y.join(o + " ") + o).split(" "), s(a, e, n))
            }
            var l,
                c,
                u = {},
                ...
                b = x.slice,
                _ = {}.hasOwnProperty;
            c = i(_, "undefined") || i(_.call, "undefined") ? function(t, e) {
                ...
                var n = b.call(arguments, 1),
                    i = function() {
                        if (this instanceof i) {
                            ...
                            var r = new o,
                                s = e.apply(r, n.concat(b.call(arguments)));
            ...
            for (var C in w)
                c(w, C) && (l = C.toLowerCase(), u[l] = w[C](), x.push((u[l] ? "" : "no-") + l));
            return u.addTest = function(t, e) {
                if ("object" == typeof t)
                    for (var i in t)
                        c(t, i) && u.addTest(i, t[i]);
                else {
                ...
                f.cssText = t
            }(""), p = null, u._version = "2.6.2", u._prefixes = m, u._domPrefixes = y, u._cssomPrefixes = v, u.testProp = function(t) {
                return r([t])
            }, u.testAllProps = a, u.testStyles = function(t, n, i, o) {
                var r,
                    s,
                    a,
                    l,
                ...
                if (parseInt(i, 10))
                    for (; i--;)
                        a = e.createElement("div"), a.id = o ? o[i] : h + (i + 1), c.appendChild(a);
                return r = ["&#173;", '<style id="s', h, '">', t, "</style>"].join(""), c.id = h, (u ? c : p).innerHTML += r, p.appendChild(c), u || (p.style.background = "", p.style.overflow = "hidden", l = d.style.overflow, d.style.overflow = "hidden", d.appendChild(p)), s = n(c, t), u ? c.parentNode.removeChild(c) : (p.parentNode.removeChild(p), d.style.overflow = l), !!s
        ...
        we = "webkit moz o ms khtml".split(" ");
    if (void 0 !== e.cancelFullScreen)
        ye.ok = !0;
    else
        for (var xe = 0, be = we.length; be > xe; xe++)
            if (ye.prefix = we[xe], void 0 !== e[ye.prefix + "CancelFullScreen"]) {
                ye.ok = !0;
                break
            }
    ...
    !function(t, e) {
        ...
        function i(t, e, n, i) {
            var o = ["opacity", e, ~~(100 * t), n, i].join("-"),
                ...
                l = a && "-" + a + "-" || "";
            return p[o] || (f.insertRule("@" + l + "keyframes " + o + "{0%{opacity:" + s + "}" + r + "%{opacity:" + t + "}" + (r + .01) + "%{opacity:1}" + (r + e) % 100 + "%{opacity:" + t + "}100%{opacity:" + s + "}}", f.cssRules.length), p[o] = 1), o
        }
        function r(t, e) {
            var n,
                i,
        ...
        function u(t) {
            return void 0 === this ? new u(t) : void (this.opts = a(t || {}, u.defaults, m))
        }
        var d,
            h = ["webkit", "Moz", "ms", "O"],
            p = {},
        ...
        u.defaults = {}, a(u.prototype, {
            spin: function(e) {
                ...
                if (e && (e.insertBefore(a, e.firstChild || null), i = l(e), n = l(a), s(a, {
                    left: ("auto" == r.left ? i.x - n.x + (e.offsetWidth >> 1) : parseInt(r.left, 10) + c) + "px",
                    top: ("auto" == r.top ? i.y - n.y + (e.offsetHeight >> 1) : parseInt(r.top, 10) + c) + "px"
                })), a.setAttribute("role", "progressbar"), o.lines(a, o.opts), !d) {
                    var u,
                        h = 0,
                    ...
                    !function t() {
                        ...
                        for (var e = 0; e < r.lines; e++)
                            u = Math.max(1 - (h + (r.lines - e) * v) % m * g, r.opacity), o.opacity(a, e * r.direction + p, u, r);
            ...
            lines: function(e, o) {
                ...
                for (var a, l = 0, u = (o.lines - 1) * (1 - o.direction) / 2; l < o.lines; l++)
                    a = s(t(), {
                        ...
                        opacity: o.opacity,
                        animation: d && i(o.opacity, o.trail, u + l * o.direction, o.lines) + " " + 1 / o.speed + "s linear infinite"
                    }), o.shadow && n(a, s(r("#000", "0 0 4px #000"), {
                        top: "2px"
                    })), n(e, n(a, r(c(o.color, l), "0 0 1px rgba(0,0,0,.1)")));
                return e
            },
        ...
        return !r(g, "transform") && g.adj ? function() {
            ...
            f.addRule(".spin-vml", "behavior:url(#default#VML)"), u.prototype.lines = function(t, i) {
                function o() {
                    return s(e("group", {
                        coordsize: u + " " + u,
                        coordorigin: -l + " " + -l
                ...
                var o = t.firstChild;
                i = i.shadow && i.lines || 0, o && e + i < o.childNodes.length && (o = o.childNodes[e + i], o = o && o.firstChild, (o = o && o.firstChild) && (o.opacity = n))
            }
        }() : d = r(g, "animation"), u
    });
    var ke,
        ...
        Se = i(t),
        $e = i(e),
        je = "quirks" === n.hash.replace("#", ""),
        Pe = ve.csstransforms3d,
        Ae = Pe && !je,
        De = Pe || "CSS1Compat" === e.compatMode,
        Ne = ye.ok,
        Me = navigator.userAgent.match(/Android|webOS|iPhone|iPad|iPod|BlackBerry|Windows Phone/i),
        Ie = !Ae || Me,
        ze = navigator.msPointerEnabled,
        Oe = "onwheel" in e.createElement("div") ? "wheel" : e.onmousewheel !== o ? "mousewheel" : "DOMMouseScroll",
        Le = 250,
        Fe = 300,
        qe = 1400,
        He = 5e3,
            ...
            if ("function" != typeof i.easing[e]) {
                var n = function(t, e) {
                    var n = [null, null],
                        ...
                        o = [null, null],
                        r = function(r, s) {
                            return o[s] = 3 * t[s], i[s] = 3 * (e[s] - t[s]) - o[s], n[s] = 1 - o[s] - i[s], r * (o[s] + r * (i[s] + r * n[s]))
                        },
                        s = function(t) {
                            return o[0] + t * (2 * i[0] + 3 * n[0] * t)
                        },
                        a = function(t) {
                            for (var e, n = t, i = 0; ++i < 14 && (e = r(n, 0) - t, !(Math.abs(e) < .001));)
                                n -= e / s(n);
                            return n
                        };
                    return function(t) {
                ...
                i.easing[e] = function(e, i, o, r, s) {
                    return r * n([t[0], t[1]], [t[2], t[3]])(i / s) + o
                }
            }
            return e
        }([.1, 0, .25, 1]),
    ...
    jQuery.Fotorama = function(t, o) {
        function r() {
            i.each(Tn, function(t, e) {
                if (!e.i) {
                    e.i = hi++;
                    var n = k(e.video, !0);
                    if (n) {
                        var i = {};
                        e.video = n, e.img || e.thumb ? e.thumbsReady = !0 : i = E(e, Tn, li), S(Tn, {
                            img: i.img,
                            thumb: i.thumb
                        }, e.i, li)
                    }
        ...
        function l(t) {
            ...
            t ? ($e.on(i, function(t) {
                var e,
                    n;
                $n && 27 === t.keyCode ? (e = !0, hn($n, !0, !0)) : (li.fullScreen || o.keyboard && !li.index) && (27 === t.keyCode ? (e = !0, li.cancelFullScreen()) : t.shiftKey && 32 === t.keyCode && a("space") || 37 === t.keyCode && a("left") || 38 === t.keyCode && a("up") ? n = "<" : 32 === t.keyCode && a("space") || 39 === t.keyCode && a("right") || 40 === t.keyCode && a("down") ? n = ">" : 36 === t.keyCode && a("home") ? n = "<<" : 35 === t.keyCode && a("end") && (n = ">>")), (e || n) && Z(t), n && li.show({
                    index: n,
                    slow: t.altKey,
                    user: !0
                })
            }), li.index || $e.off(e).on(e, "textarea, input, select", function(t) {
                !Ee.hasClass(lt) && t.stopPropagation()
            }), Se.on(r, li.resize)) : ($e.off(i), Se.off(r))
        }
        function d(e) {
            e !== d.f && (e ? (t.html("").addClass(at + " " + ui).append(gi).before(fi).before(mi), rt(li)) : (gi.detach(), fi.detach(), mi.detach(), t.html(pi.urtext).removeClass(ui), st(li)), l(e), d.f = e)
        }
        function p() {
            Tn = li.data = Tn || q(o.data) || $(t), kn = li.size = Tn.length, !Cn.ok && o.shuffle && F(Tn), r(), Mi = T(Mi), kn && d(!0)
        }
        function y() {
            var t = 2 > kn && !o.enableifsingleframe || $n;
            Oi.noMove = t || Bn, Oi.noSwipe = t || !o.swipe, !Vn && yi.toggleClass(Et, !o.click && !Oi.noMove && !Oi.noSwipe), ze && gi.toggleClass(vt, !Oi.noSwipe)
        }
        function w(t) {
            !0 === t && (t = ""), o.autoplay = Math.max(+t || He, 1.5 * Qn)
        }
        function _() {
            function t(t, n) {
                e[t ? "add" : "remove"].push(n)
            }
            li.options = o = R(o), Bn = "crossfade" === o.transition || "dissolve" === o.transition, Ln = o.loop && (kn > 2 || Bn && (!Vn || "slide" !== Vn)), Qn = +o.transitionduration || Fe, Kn = "rtl" === o.direction, Yn = i.extend({}, o.keyboard && Ge, o.keyboard);
            var e = {
                add: [],
                remove: []
            };
            kn > 1 || o.enableifsingleframe ? (Fn = o.nav, Hn = "top" === o.navposition, e.remove.push(Qt), _i.toggle(!!o.arrows)) : (Fn = !1, _i.hide()), ne(), Sn = new _e(i.extend(Ce, o.spinner, Te, {
                direction: Kn ? -1 : 1
            })), Oe(), qe(), o.autoplay && w(o.autoplay), Un = h(o.thumbwidth) || Re, Xn = h(o.thumbheight) || Re, Li.ok = qi.ok = o.trackpad && !Ie, y(), on(o, [zi]), (qn = "thumbs" === Fn) ? (ve(kn, "navThumb"), En = Si, ai = Qe, M(fi, i.Fotorama.jst.style({
                w: Un,
                h: Xn,
                ...
                s: ci,
                q: !De
            })), Ti.addClass(zt).removeClass(It)) : "dots" === Fn ? (ve(kn, "navDot"), En = Ei, ai = Xe, Ti.addClass(It).removeClass(zt)) : (Fn = !1, Ti.removeClass(zt + " " + It)), Fn && (Hn ? Ci.insertBefore(vi) : Ci.insertAfter(vi), je.nav = !1, je(En, ki, "nav")), (Rn = o.allowfullscreen) ? (ji.prependTo(vi), Wn = Ne && "native" === Rn) : (ji.detach(), Wn = !1), t(Bn, pt), t(!Bn, ft), t(!o.captions, xt), t(Kn, yt), t("always" !== o.arrows, bt), t(!(Zn = o.shadows && !Ie), gt), gi.addClass(e.add.join(" ")).removeClass(e.remove.join(" ")), Ii = i.extend({}, o)
        }
        function C(t) {
            return 0 > t ? (kn + t % kn) % kn : t >= kn ? t % kn : t
        }
        function T(t) {
            return s(t, 0, kn - 1)
        }
        ...
        function Y(t) {
            return !!(kn - 1 > t || Ln) && t + 1
        }
        function tt() {
            Oi.min = Ln ? -1 / 0 : -g(kn - 1, zi.w, o.margin, An), Oi.max = Ln ? 1 / 0 : -g(0, zi.w, o.margin, An), Oi.snap = zi.w + o.margin
        }
        function et() {
            Fi.min = Math.min(0, zi.nw - ki.width()), Fi.max = 0, ki.toggleClass(Et, !(Fi.noMove = Fi.min === Fi.max))
        }
        function ot(t, e, n) {
            if ("number" == typeof t) {
                t = new Array(t);
            ...
            return i.each(t, function(t, i) {
                if (o && (i = t), "number" == typeof i) {
                    ...
                    if (r) {
                        var s = "$" + e + "Frame",
                            a = r[s];
                        n.call(this, t, i, r, a, s, a && a.data())
                    }
                }
            })
        }
        function qt(t, e, n, i) {
            (!Gn || "*" === Gn && i === On) && (t = m(o.width) || m(t) || We, e = m(o.height) || m(e) || Be, li.resize({
                width: t,
                ratio: o.ratio || n || t / e
            }, 0, i !== On && "*"))
        }
        function Ht(t, e, n, r, s, a) {
            ot(t, e, function(t, l, c, u, d, h) {
                function p(t) {
                    var e = C(l);
                    rn(t, {
                        index: e,
                ...
                function f() {
                    w.remove(), i.Fotorama.cache[_] = "error", c.html && "stage" === e || !T || T === _ ? (!_ || c.html || v ? "stage" === e && (u.trigger("f:load").removeClass(Gt + " " + Yt).addClass(Jt), p("load"), qt()) : (u.trigger("f:error").removeClass(Gt).addClass(Yt), p("error")), h.state = "error", !(kn > 1 && Tn[l] === c) || c.html || c.deleted || c.video || v || (c.deleted = !0, li.splice(l, 1))) : (c[b] = _ = T, Ht([l], e, n, r, s, !0))
                }
                function m() {
                    i.Fotorama.measures[_] = x.measures = i.Fotorama.measures[_] || {
                        width: y.width,
                        height: y.height,
                        ratio: y.width / y.height
                    }, qt(x.measures.width, x.measures.height, x.measures.ratio, l), w.off("load error").addClass(ie + (v ? " " + oe : "")).prependTo(u), N(w, (i.isFunction(n) ? n() : n) || zi, r || c.fit || o.fit, s || c.position || o.position), i.Fotorama.cache[_] = h.state = "loaded", setTimeout(function() {
                        u.trigger("f:load").removeClass(Gt + " " + Yt).addClass(Jt + " " + (v ? te : ee)), "stage" === e ? p("load") : (c.thumbratio === Ve || !c.thumbratio && o.thumbratio === Ve) && (c.thumbratio = x.measures.ratio, bn())
                    }, 0)
                }
                function g() {
                    var t = 10;
                ...
                if (u) {
                    var v = li.fullScreen && c.full && c.full !== c.img && !h.$full && "stage" === e;
                    if (!h.$img || a || v) {
                        var y = new Image,
                            w = i(y),
                            x = w.data();
                        ...
                        if ("navThumb" === e && (u = h.$wrap), !_)
                            return void f();
                        i.Fotorama.cache[_] ? function t() {
                            "error" === i.Fotorama.cache[_] ? f() : "loaded" === i.Fotorama.cache[_] ? setTimeout(g, 0) : setTimeout(t, 100)
                        }() : (i.Fotorama.cache[_] = "*", w.on("load", g).on("error", f)), h.state = "", y.src = _
                    }
                }
            })
        }
        function Rt(t) {
            Ni.append(Sn.spin().el).appendTo(t)
        }
        function ne() {
            Ni.detach(), Sn && Sn.stop()
        }
        function ce() {
            var t = jn[Ue];
        ...
        function ve(t, e) {
            ot(t, e, function(t, n, o, r, s, a) {
                if (!r) {
                    r = o[s] = gi[s].clone(), (a = r.data()).data = o;
                    var l = r[0];
                    "stage" === e ? (o.html && i('<div class="' + le + '"></div>').append(o._html ? i(o.html).removeAttr("id").html(o._html) : o.html).appendTo(r), o.caption && i(L(he, L(pe, o.caption))).appendTo(r), o.video && r.addClass(Tt).append(Ai.clone()), V(l, function() {
                        setTimeout(function() {
                            H(vi)
                        }, 0), mn({
                            index: a.eq,
                    ...
                    }), wi = wi.add(r)) : "navDot" === e ? (ge(l), Ei = Ei.add(r)) : "navThumb" === e && (ge(l), a.$wrap = r.children(":first"), Si = Si.add(r), o.video && a.$wrap.append(Ai.clone()))
                }
            })
        }
        function we(t, e, n, i) {
            return t && t.length && N(t, e, n, i)
        }
        function xe(t) {
            ot(t, "stage", function(t, e, n, r, s, a) {
                if (r) {
                    var l = C(e),
                        c = n.fit || o.fit,
                        d = n.position || o.position;
                    a.eq = l, Ri[Ue][l] = r.css(i.extend({
                        left: Bn ? 0 : g(e, zi.w, o.margin, An)
                    }, Bn && u(0))), P(r[0]) && (r.appendTo(yi), hn(n.$video)), we(a.$img, zi, c, d), we(a.$full, zi, c, d)
                }
            })
        }
        function be(t, e) {
            if ("thumbs" === Fn && !isNaN(t)) {
                var n = -t,
                    r = -t + zi.nw;
                Si.each(function() {
                    var t = i(this).data(),
                        ...
                        l = a(),
                        c = Tn[s] || {},
                        u = c.thumbfit || o.thumbfit,
                        d = c.thumbposition || o.thumbposition;
                    l.w = t.w, t.l + t.w < n || t.l > r || we(t.$img, l, u, d) || e && Ht([s], "navThumb", a, u, d)
                })
            }
        }
        function je(t, e, n) {
            if (!je[n]) {
                ...
                e.append(t.filter(function() {
                    for (var t, e = i(this), n = e.data(), o = 0, r = Tn.length; r > o; o++)
                        if (n.data === Tn[o]) {
                            t = !0, n.eq = o;
                            break
                        }
                    ...
                    if (r) {
                        var t = i(this),
                            e = t.data(),
                            n = Math.round(Xn * e.data.thumbratio) || Un;
                        e.l = s, e.w = n, t.css({
                            width: n
                        }), s += n + o.thumbmargin
                    }
        ...
        function Me(t) {
            return !(Ln || Mi + t && Mi - kn + t || $n)
        }
        function Oe() {
            var t = Me(0),
                e = Me(1);
            xi.toggleClass(jt, t).attr(X(t)), bi.toggleClass(jt, e).attr(X(e))
        }
        function qe() {
            Li.ok && (Li.prevent = {
                "<": Me(0),
        ...
        function Ye(t) {
            var e = Tn[t.guessIndex][ai];
            if (e) {
                var n = Fi.min !== Fi.max,
                    i = t.minMax || n && Ze(jn[ai]),
                    o = n && (t.keep && Ye.l ? Ye.l : s((t.coo || zi.nw / 2) - Ze(e).c, i.min, i.max)),
                    r = n && s(o, Fi.min, Fi.max),
                    a = 1.1 * t.time;
                G(ki, {
                    time: a,
                    pos: r || 0,
                ...
                }), dn(Ti, I(r, Fi.min, Fi.max)), Ye.l = o
            }
        }
        function Je() {
            tn(ai), Hi[ai].push(jn[ai].addClass(Xt))
        }
        function tn(t) {
            for (var e = Hi[t]; e.length;)
                e.shift().removeClass(Xt)
        }
        function en(t) {
            var e = Ri[t];
            i.each(Pn, function(t, n) {
                delete e[C(n)]
        ...
        function nn(t) {
            An = Dn = Mi;
            var e = jn[Ue];
            e && (tn(Ue), Hi[Ue].push(e.addClass(Xt)), t || li.show.onEnd(!0), x(yi, 0, !0), en(Ue), xe(Pn), tt(), et())
        }
        function on(t, e) {
        ...
        function sn() {
            clearTimeout(an.t), ri = 1, o.stopautoplayontouch ? li.stopAutoplay() : ni = !0
        }
        function an() {
            ri && (o.stopautoplayontouch || (ln(), cn()), an.t = setTimeout(function() {
                ri = 0
            }, Fe + Le))
        }
        function ln() {
        ...
        function cn() {
            if (clearTimeout(cn.t), A.stop(cn.w), o.autoplay && !ni) {
                li.autoplay || (li.autoplay = !0, rn("startautoplay"));
                var t = Mi,
                    e = jn[Ue].data();
                cn.w = A(function() {
                    return e.state || t !== Mi
                    ...
                    cn.t = setTimeout(function() {
                        if (!ni && t === Mi) {
                            ...
                            cn.w = A(function() {
                                ...
                                ni || e !== zn || li.show(Ln ? K(!Kn) : zn)
                            })
                        }
                    }, o.autoplay)
                })
            } else
                li.autoplay && (li.autoplay = !1, rn("stopautoplay"))
        }
        function un() {
            li.fullScreen && (li.fullScreen = !1, Ne && ye.cancel(di), Ee.removeClass(lt), ke.removeClass(lt), t.removeClass(Zt).insertAfter(mi), zi = i.extend({}, oi), hn($n, !0, !0), vn("x", !1), li.resize(), Ht(Pn, "stage"), H(Se, ti, Jn), rn("fullscreenexit"))
        }
        function dn(t, e) {
            Zn && (t.removeClass(Bt + " " + Ut), e && !$n && t.addClass(e.replace(/^|\s/g, " " + Wt + "--")))
        }
        function hn(t, e, n) {
            e && (gi.removeClass(ht), $n = !1, y()), t && t !== $n && (t.remove(), rn("unloadvideo")), n && (ln(), cn())
        }
        function pn(t) {
            gi.toggleClass(mt, t)
        }
        function fn(t) {
            if (!Oi.flow) {
                var e = t ? t.pageX : fn.x,
                    n = e && !Me(Pe(e)) && o.click;
                fn.p !== n && vi.toggleClass(St, n) && (fn.p = n, fn.x = e)
            }
        }
        function mn(t) {
            clearTimeout(mn.t), o.clicktransition && o.clicktransition !== o.transition ? setTimeout(function() {
                var e = o.transition;
                li.setOptions({
                    transition: o.clicktransition
                }), Vn = e, mn.t = setTimeout(function() {
                    li.show(t)
                }, 10)
            }, 0) : li.show(t)
        }
        function gn(t, e) {
            var n = t.target;
            i(n).hasClass(ue) ? li.playVideo() : n === Pi ? li.toggleFullScreen() : $n ? n === Di && hn($n, !0, !0) : e ? pn() : o.click && mn({
                index: t.shiftKey || K(Pe(t._x)),
                slow: t.altKey,
                user: !0
            })
        }
        ...
        function yn(t) {
            mn({
                index: i(this).data().eq,
                slow: t.altKey,
                user: !0,
                coo: t._x - Ti.offset().left
            })
        }
        function wn(t) {
            mn({
        ...
        function bn() {
            if (p(), _(), !bn.i) {
                bn.i = !0;
                var t = o.startindex;
                (t || o.hash && n.hash) && (On = z(t || n.hash.replace(/^#/, ""), Tn, 0 === li.index || t, t)), Mi = An = Dn = Nn = On = j(On) || 0
            }
            if (kn) {
                if (_n())
                    return;
                $n && hn($n, !0), Pn = [], en(Ue), bn.ok = !0, li.show({
                    index: Mi,
                    time: 0
                }), li.resize()
            } else
        ...
        function _n() {
            return !_n.f === Kn ? (_n.f = Kn, Mi = kn - 1 - Mi, li.reverse(), !0) : void 0
        }
        function Cn() {
        ...
        var Tn,
            ...
            mi = i(L(Vt)),
            gi = i(L(ct)),
            vi = i(L(_t)).appendTo(gi),
            yi = (vi[0], i(L(kt)).appendTo(vi)),
            wi = i(),
            xi = i(L($t + " " + Pt + me)),
            bi = i(L($t + " " + At + me)),
            _i = xi.add(bi).appendTo(vi),
            Ci = i(L(Nt)),
            Ti = i(L(Dt)).appendTo(Ci),
            ki = i(L(Mt)).appendTo(Ti),
            Ei = i(),
            Si = i(),
            $i = (yi.data(), ki.data(), i(L(ae)).appendTo(ki)),
            ji = i(L(Kt + me)),
            Pi = ji[0],
            Ai = i(L(ue)),
            Di = i(L(de)).appendTo(vi)[0],
            Ni = i(L(fe)),
            Mi = !1,
            Ii = {},
            zi = {},
            ...
            Wi = 0,
            Bi = [];
        gi[Ue] = i(L(Ct)), gi[Qe] = i(L(Ot + " " + Ft + me, L(se))), gi[Xe] = i(L(Ot + " " + Lt + me, L(re))), Hi[Ue] = [], Hi[Qe] = [], Hi[Xe] = [], Ri[Ue] = {}, gi.addClass(Ae ? dt : ut).toggleClass(mt, !o.controlsonstart), pi.fotorama = this, li.startAutoplay = function(t) {
            return li.autoplay ? this : (ni = ii = !1, w(t || o.autoplay), cn(), this)
        }, li.stopAutoplay = function() {
            return li.autoplay && (ni = ii = !0, cn()), this
        }, li.show = function(t) {
            var e;
            "object" != typeof t ? (e = t, t = {}) : e = t.index, e = ">" === e ? Dn + 1 : "<" === e ? Dn - 1 : "<<" === e ? 0 : ">>" === e ? kn - 1 : e, e = void 0 === (e = isNaN(e) ? z(e, Tn, !0) : e) ? Mi || 0 : e, li.activeIndex = Mi = j(e), Mn = U(Mi), In = Y(Mi), zn = C(Mi + (Kn ? -1 : 1)), Pn = [Mi, Mn, In], Dn = Ln ? e : Mi;
            var n = Math.abs(Nn - Dn),
                i = b(t.time, function() {
            ...
            t.slow && (i *= 10);
            var a = jn;
            li.activeFrame = jn = Tn[Mi];
            var l = a === jn && !t.user;
            hn($n, jn.i !== Tn[C(An)].i), ve(Pn, "stage"), xe(Ie ? [Dn] : [Dn, U(Dn), Y(Dn)]), vn("go", !0), l || rn("show", {
                user: t.user,
                time: i
            }), ni = !0;
            var c = li.show.onEnd = function(e) {
                if (!c.ok) {
                    if (c.ok = !0, e || nn(!0), l || rn("showend", {
                        user: t.user
                    }), !e && Vn && Vn !== o.transition)
                        return li.setOptions({
                            transition: Vn
                        }), void (Vn = !1);
                    ce(), Ht(Pn, "stage"), vn("go", !1), qe(), fn(), ln(), cn()
                }
            };
            if (Bn ? J(jn[Ue], Mi !== Nn ? Tn[Nn][Ue] : null, wi, {
                time: i,
                method: o.transition,
                onEnd: c
            }, Bi) : G(yi, {
                pos: -g(Dn, zi.w, o.margin, An),
                overPos: r,
                time: i,
                onEnd: c
            }), Oe(), Fn) {
                Je();
                var u = T(Mi + s(Dn - Nn, -1, 1));
                Ye({
                    time: i,
                    coo: u !== Mi && t.coo,
                    guessIndex: void 0 !== t.coo ? u : Mi,
                    keep: l
                }), qn && Ke(i)
            }
            return ei = void 0 !== Nn && Nn !== Mi, Nn = Mi, o.hash && ei && !li.eq && D(jn.id || Mi + 1), this
        }, li.requestFullScreen = function() {
            return Rn && !li.fullScreen && (Jn = Se.scrollTop(), ti = Se.scrollLeft(), H(Se), vn("x", !0), oi = i.extend({}, zi), t.addClass(Zt).appendTo(Ee.addClass(lt)), ke.addClass(lt), hn($n, !0, !0), li.fullScreen = !0, Wn && ye.request(di), li.resize(), Ht(Pn, "stage"), ce(), rn("fullscreenenter")), this
        }, li.cancelFullScreen = function() {
            return Wn && ye.is() ? ye.cancel(e) : un(), this
        }, li.toggleFullScreen = function() {
            return li[(li.fullScreen ? "cancel" : "request") + "FullScreen"]()
        }, B(e, ye.event, function() {
            !Tn || ye.is() || $n || un()
        }), li.resize = function(t) {
            if (!Tn)
                return this;
            var e = arguments[1] || 0,
                n = arguments[2];
            on(li.fullScreen ? {
                ...
                maxheight: null,
                minheight: null
            } : R(t), [zi, n || li.fullScreen || o]);
            var i = zi.width,
                r = zi.height,
                a = zi.ratio,
                l = Se.height() - (Fn ? Ti.height() : 0);
            return m(i) && (gi.addClass(wt).css({
                width: i,
                minWidth: zi.minwidth || 0,
                maxWidth: zi.maxwidth || 99999
            }), i = zi.W = zi.w = gi.width(), zi.nw = Fn && f(o.navwidth, i) || i, o.glimpse && (zi.w -= Math.round(2 * (f(o.glimpse, i) || 0))), yi.css({
                width: zi.w,
                marginLeft: (zi.W - zi.w) / 2
            }), r = f(r, l), (r = r || a && i / a) && (i = Math.round(i), r = zi.h = Math.round(s(r, f(zi.minheight, l), f(zi.maxheight, l))), vi.stop().animate({
                width: i,
                height: r
            }, e, function() {
                gi.removeClass(wt)
            }), nn(), Fn && (Ti.stop().animate({
                width: zi.nw
            }, e), Ye({
                guessIndex: Mi,
                time: e,
                keep: !0
            }), qn && je.nav && Ke(e)), Gn = n || !0, Cn())), Wi = vi.offset().left, this
        }, li.setOptions = function(t) {
            return i.extend(o, t), bn(), this
        }, li.shuffle = function() {
            return Tn && F(Tn) && bn(), this
        }, li.destroy = function() {
            return li.cancelFullScreen(), li.stopAutoplay(), Tn = li.data = null, d(), Pn = [], en(Ue), bn.ok = !1, this
        }, li.playVideo = function() {
            var t = jn,
                e = t.video,
                n = Mi;
            return "object" == typeof e && t.videoReady && (Wn && li.fullScreen && li.cancelFullScreen(), A(function() {
                return !ye.is() || n !== Mi
            }, function() {
                n === Mi && (t.$video = t.$video || i(i.Fotorama.jst.video(e)), t.$video.appendTo(t[Ue]), gi.addClass(ht), $n = t.$video, y(), _i.blur(), ji.blur(), rn("loadvideo"))
            })), this
        }, li.stopVideo = function() {
            return hn($n, !0, !0), this
        }, vi.on("mousemove", fn), Oi = nt(yi, {
            onStart: sn,
            onMove: function(t, e) {
                dn(vi, e.edge)
            },
            ...
            onEnd: function(t) {
                dn(vi);
                var e = (ze && !si || t.touch) && o.arrows && "always" !== o.arrows;
                if (t.moved || e && t.pos !== t.newPos && !t.control) {
                    var n = v(t.newPos, zi.w, o.margin, An);
                    li.show({
                        index: n,
                        time: Bn ? Qn : t.time,
                        overPos: t.overPos,
                    ...
                    t.aborted || t.control || gn(t.startEvent, e)
            },
            timeLow: 1,
            timeHigh: 1,
            friction: 2,
            ...
            onEnd: function(t) {
                function e() {
                    Ye.l = t.newPos, ln(), cn(), be(t.newPos, !0)
                }
                if (t.moved)
                    t.pos !== t.newPos ? (ni = !0, G(ki, {
                        time: t.time,
                        pos: t.newPos,
                        overPos: t.overPos,
                        onEnd: e
                    }), be(t.newPos), Zn && dn(Ti, I(t.newPos, Fi.min, Fi.max))) : e();
                else {
                    var n = t.$target.closest("." + Ot, ki)[0];
            ...
            onEnd: function(t, e) {
                sn(), an();
                var n = x(ki) + .25 * e;
                ki.css(c(s(n, Fi.min, Fi.max))), Zn && dn(Ti, I(n, Fi.min, Fi.max)), qi.prevent = {
                    "<": n >= Fi.max,
                    ">": n <= Fi.min
                }, clearTimeout(qi.t), qi.t = setTimeout(function() {
                    Ye.l = n, be(n, !0)
                }, Le), be(n)
            }
        }), gi.hover(function() {
        ...
        }), Q(Pi, li.toggleFullScreen), xn(Pi), i.each("load push pop shift unshift reverse sort splice".split(" "), function(t, e) {
            li[e] = function() {
                return Tn = Tn || [], "load" !== e ? Array.prototype[e].apply(Tn, arguments) : arguments[0] && "object" == typeof arguments[0] && arguments[0].length && (Tn = q(arguments[0])), bn(), li
            }
        }), bn()
        ...
        return this.each(function() {
            var n = this,
                ...
                r = o.data(),
                s = r.fotorama;
            s ? s.setOptions(e, !0) : A(function() {
                return !j(n)
            }, function() {
                r.urtext = o.html(), new i.Fotorama(o, i.extend({}, Ye, t.fotoramaDefaults, e, r))
            })
        })
    }, i.Fotorama.instances = [], i.Fotorama.cache = {}, i.Fotorama.measures = {}, (i = i || {}).Fotorama = i.Fotorama || {}, i.Fotorama.jst = i.Fotorama.jst || {}, i.Fotorama.jst.style = function(t) {
        var e,
            n = "";
        ...
        i("." + at + ':not([data-auto="false"])').fotorama()
    })
}(window, document, location, "undefined" != typeof jQuery && jQuery), $(function() {
    $(".mobile-icon").click(function() {
        $(".mobile-nav").addClass("mobile-nav-open"), $(".shadow-menu").show()
    }), $(".close-menu").click(function() {
        $(".mobile-nav").removeClass("mobile-nav-open"), $(".shadow-menu").hide()
        ...
        $(this).css("background", "#a29f9e"), $(".contact-form .phone .off").css("background", "#e3e2e2"), $(".contact-form .email").css("background", "#e3e2e2"), $("#input-phone").show(), $("#input-email").hide()
    }), $(".contact-form .email").click(function() {
        $(this).css("background", "#a29f9e"), $(".contact-form .phone .off").css("background", "#a29f9e"), $(".contact-form .phone").css("background", "#e3e2e2"), $("#input-phone").hide(), $("#input-email").show()
    }), $(".product-text .li-text").click(function() {
        $(".product-text .li-text").addClass("li-active"), $(".product-text .li-size").removeClass("li-active"), $(".product-text .li-complect").removeClass("li-active"), $(".product-text .text").show(), $(".product-text .size").hide(), $(".product-text .complect").hide(), $(".product-text .schema").hide()
    }), $(".product-text .li-size").click(function() {
        $(this).addClass("li-active"), $(".product-text .li-text").removeClass("li-active"), $(".product-text .li-complect").removeClass("li-active"), $(".product-text .size").show(), $(".product-text .text").hide(), $(".product-text .complect").hide(), $(".product-text .schema").hide()
    }), $(".product-text .li-complect").click(function() {
        $(this).addClass("li-active"), $(".product-text .li-text").removeClass("li-active"), $(".product-text .li-size").removeClass("li-active"), $(".product-text .complect").show(), $(".product-text .text").hide(), $(".product-text .size").hide(), $(".product-text .schema").hide()
        ...
        let followings = localStorage.getItem('product-followings');
        if (followings == null) {
            followings = [];
        } else {
            followings = JSON.parse(followings);
            for (let i = 0; i < followings.length; i++) {
                if (time - followings[i].datetime > 1800000) {
        ...
        if (history == null) {
            ...
            for (let i = 0; i < history.length; i++) {
                if (time - history[i].datetime > 1800000) {
                    history.splice(i--, 1);
                }
            }
        }
        ...
        let stop = false;
        for (let i = 0; i < window.followings.length; i++) {
            if (stop || window.followings[i].from != url) {
                continue;
            }
            for (let j = 0; j < history.length; j++) {
                if (history[j].url == window.followings[i].to) {
                    body.animate({ scrollTop: window.followings[i].top }, 500, 'swing');
                    stop = true;
                    break;
                }
            }
        ...
        let href = $(this).attr('href').replace(location.origin, '');
        if (href.indexOf('product/') != -1) {
            let time = new Date();
            time = time.getTime();
            let from = location.href.replace(location.origin, '');
            let top = $('body').scrollTop();

            for (let i = 0; i < window.followings.length; i++) {
                if (window.followings[i].from == from && window.followings[i].to == href) {
                    window.followings.splice(i--, 1);
                }
            }
            window.followings.unshift({
                'datetime': time,
                'from': from,
                'to': href,
                'top': top
            });
            localStorage.setItem('product-followings', JSON.stringify(window.followings));
        }
    })
});