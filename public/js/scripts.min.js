!function(t, e) {
    ...
    $(".mobile-icon").click(function() {
        ...
        $(".product-text .li-text").addClass("li-active"), $(".product-text .li-size").removeClass("li-active"), $(".product-text .li-complect").removeClass("li-active"), $(".product-text .text").show(), $(".product-text .size").hide(), $(".product-text .complect").hide()
    }), $(".product-text .li-size").click(function() {
        $(this).addClass("li-active"), $(".product-text .li-text").removeClass("li-active"), $(".product-text .li-complect").removeClass("li-active"), $(".product-text .size").show(), $(".product-text .text").hide(), $(".product-text .complect").hide()
    }), $(".product-text .li-complect").click(function() {
        $(this).addClass("li-active"), $(".product-text .li-text").removeClass("li-active"), $(".product-text .li-size").removeClass("li-active"), $(".product-text .complect").show(), $(".product-text .text").hide(), $(".product-text .size").hide()
    })
});
