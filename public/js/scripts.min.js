!function(t, e) {
    ...
    ft.ajaxSetup({
        ...
        var i,
            o,
            r;
        return e || (ht.createHTMLDocument ? (e = et.implementation.createHTMLDocument(""), i = e.createElement("base"), i.href = et.location.href, e.head.appendChild(i)) : e = et), o = Ct.exec(t), r = !n && [], o ? [e.createElement(o[1])] : (o = x([t], e, r), r && r.length && ft(r).remove(), ft.merge([], o.childNodes))
    ...
    $(".mobile-icon").click(function() {
        ...
        $(".product-text .li-text").addClass("li-active"), $(".product-text .li-schema").removeClass("li-active"), $(".product-text .li-size").removeClass("li-active"), $(".product-text .li-complect").removeClass("li-active"), $(".product-text .text").show(), $(".product-text .size").hide(), $(".product-text .complect").hide(), $(".product-text .schema").hide()
    }), $(".product-text .li-size").click(function() {
        $(this).addClass("li-active"), $(".product-text .li-schema").removeClass("li-active"), $(".product-text .li-text").removeClass("li-active"), $(".product-text .li-complect").removeClass("li-active"), $(".product-text .size").show(), $(".product-text .text").hide(), $(".product-text .complect").hide(), $(".product-text .schema").hide()
    }), $(".product-text .li-complect").click(function() {
        $(this).addClass("li-active"), $(".product-text .li-schema").removeClass("li-active"), $(".product-text .li-text").removeClass("li-active"), $(".product-text .li-size").removeClass("li-active"), $(".product-text .complect").show(), $(".product-text .text").hide(), $(".product-text .size").hide(), $(".product-text .schema").hide()
    }), $(".product-text .li-schema").click(function() {
        $(this).addClass("li-active"), $(".product-text .li-text").removeClass("li-active"), $(".product-text .li-size").removeClass("li-active"), $(".product-text .schema").show(), $(".product-text .complect").hide(), $(".product-text .text").hide(), $(".product-text .size").hide()
